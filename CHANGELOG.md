...
- Update Atlas to v0.37.0

## [v7.4.1]

### Removed

- Remove Sonar from `go-ci`

## [v7.4.0]

### Updated

- Update package version in line with github release

## [v7.2.0]

### Updated

- Remove caching from go-setup and update artifact steps
...
- Manually triggering a proper version
